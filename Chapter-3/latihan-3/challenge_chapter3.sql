...
--Membuat database pemesanan tiket bioskop secara online
...
--
-- customers,reservations,seats,studios,schedules,movies
...
--cek isi data table studios yang id =1
SELECT * FROM studios
where id = 1;

--mengubah isi tabel movies
UPDATE movies 
SET title = 'Gara Gara Warisan'
WHERE id=3;

--menghapus isi tabel seats
DELETE FROM seats
WHERE id=2;

--menghapus isi tabel movies
DELETE FROM movies
WHERE id=1;
