...
INSERT INTO customers (name,address) values ('doremi', 'bandung');

INSERT INTO products (name,stock) values ('budi', 10);
INSERT INTO products (name,stock) values ('doremi', 10);
