...
--
-- Name: stock(integer, integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.stock(IN product_id integer, IN qty integer)
    LANGUAGE plpgsql
    AS $$
begin
...
ALTER PROCEDURE public.stock(IN product_id integer, IN qty integer) OWNER TO postgres;
...
COPY public.products (id, name, deskripsi, stock) FROM stdin;
1	Laptop	Laptop Asus untuk mahasiswa	10
\.
